...
<div style="margin-top: 130px;">
	 <div class="container jumbotron">
	 	<h2 class="text-center" style="margin-bottom: 40px;font-family:'Time New Roman' ">Images & Videos Packages</h2>
	 	<div class="row">
		 				...
		 				<tr>
		 					...
		 					<td><span class="fa fa-picture-o btn-sm btn-danger"></span>&nbsp;{{$postpackage->total_amount}} kyts</td>
		 					  ...
		 					  <td>
	                         	...
	                         	<a href="{{url('buypackage/'.$postpackage->id)}}" class="btn-sm btn-success">Package</a>
                             </td>
                             <td>
		 			...
		 			<tbody>
		 				@foreach($videopackages as $videopackage)
		 				  <tr>
		 					...
		 					<td>
		 						<!-- <span class="fa fa-cart-plus btn-sm btn-danger"></span> -->
                           	    <a href="{{url('buypackage/'.$videopackage->id)}}" class="btn-sm btn-success">Package</a>
                           	</td>
                           	<td>
