...
<?php  
   ...
   ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-success" style="border-radius: 10px 10px 0px 0px"><h2 class="text-center">Post Creation</h2></div>
                <div class="card-body" style="background:#000;">
                    <form method="post" enctype="multipart/form-data">
                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="file" class="col-md-4 col-form-label text-md-right" style="color: #fff;">Select Photo</label>

                            <div class="col-md-6">
                                <span class="fa fa-camera" style="font-size: 30px;"></span>
                                <input id="file" type="file" class="form-control" name="file1">
                            </div>
                        </div>
                         <div class="form-group row">
                            <label for="file" class="col-md-4 col-form-label text-md-right" style="color: #fff;">Select Photo</label>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <span class="fa fa-camera" style="font-size: 30px;"></span>
                                <input id="file" type="file" class="form-control" name="file3">
                            </div>
                        </div>
